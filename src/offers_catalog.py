...
OFFERS_CATALOG = {
    ...
    "ready_to_buy": {
        "text_clear": "Запись на пробное занятие открыта. Вот прямая ссылка: shao3d.github.io/trial/. В группах осталось всего несколько мест, рекомендуем не откладывать.",
        "text_unclear": "Что именно вы хотите сделать - записаться на курс или узнать больше информации? Для записи перейдите на shao3d.github.io/trial/ или оставьте ваш контакт.",
        "text": "Запись на пробное занятие открыта. Вот прямая ссылка: shao3d.github.io/trial/. В группах осталось всего несколько мест, рекомендуем не откладывать.",
        "text_variants": [
            "Запись на пробное занятие открыта. Переходите по ссылке: shao3d.github.io/trial/. В группах осталось всего несколько мест.",
            "Вы можете записаться прямо сейчас: shao3d.github.io/trial/. Ближайшие занятия начинаются на следующей неделе, места быстро разбирают.",
            "Готовы начать? Переходите на shao3d.github.io/trial/ для записи. Можем подобрать удобное время - у нас есть утренние, дневные и вечерние группы.",
            "Отлично! Давайте запишем вас на пробное занятие: shao3d.github.io/trial/. Это займёт буквально 2 минуты, и вы сразу получите подтверждение."
        ],
        "priority": "high",
...
Assistant: Отлично, что вы готовы начать! Вот простые шаги: 1) Перейдите по ссылке shao3d.github.io/trial/ для записи на бесплатное пробное занятие. 2) Выберите удобное время - у нас есть группы в 17:00 и 19:00. 3) Заполните короткую форму (2 минуты). После пробного занятия вы сможете принять окончательное решение. Ближайшее занятие уже в эту субботу, осталось 3 места в группе.
""",
...
def get_offer(user_signal: str, history: list = None) -> dict:
    ...
    if user_signal == "ready_to_buy" and history:
        ...
        for msg in history[-6:]:  # Проверяем последние 3 пары сообщений
            if msg.get("role") == "assistant" and "shao3d.github.io/trial/" in msg.get("content", ""):
