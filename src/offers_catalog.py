...
OFFERS_CATALOG = {
    ...
    "anxiety_about_child": {
        "text": "Мы понимаем ваши переживания. Первое занятие всегда бесплатное - это поможет понять, подходит ли наш подход вашему ребенку.",
        "text_variants": [
    ...
    "ready_to_buy": {
        ...
        "text_variants": [
            ...
            "Супер! Вы можете записаться прямо сейчас по ссылке: ukido.ua/trial. Ближайшие занятия начинаются на следующей неделе, места быстро разбирают.",
