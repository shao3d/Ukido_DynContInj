"""
Золотой запас примеров в стиле Михаила Жванецкого для модели юмора.
...
GOLDEN_EXAMPLES = {
    ...
    "general": [
        ...
        {
            "topic": "Zoom-чат",
            "example": "В Zoom-чате урока 200 сообщений. И все одновременно. Учим детей поднимать руку виртуально - хоть какой-то порядок."
        },
        {
            "topic": "чат группы",
            "example": "Чат Zoom-группы - единственное место, где emoji используют чаще, чем слова. А микрофон включают реже, чем случайно."
        },
        {
        ...
        {
            "topic": "домашка",
            "example": "Домашка онлайн - это когда вся семья в кадре пытается выглядеть незаинтересованной. А кот уже третий раз проходит по клавиатуре."
        },
        {
            "topic": "уроки",
        ...
        {
            "topic": "математика",
            "example": "Современная математика онлайн: ребёнок решает примеры, а калькулятор Google открыт на соседней вкладке. Честность - тоже навык."
        },
        {
...
def format_examples_for_prompt(examples: list) -> str:
    """
    Форматировать примеры для промпта модели юмора.
